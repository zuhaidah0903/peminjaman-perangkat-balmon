...
<head>
	...
	<title>Berita Acara Pinjam</title>
	<style>
		body {  
...
<body>
	...
	<div class="w-85 center-div mt-20">	
		<p class="t-underline center-text t-14 t-bold">
			BERITA ACARA PINJAM PAKAI BARANG INVENTARIS (SEMENTARA)
		</p>
		...
		<p class="t-justify" style="margin-top: 15px; margin-bottom: 30px">
			Selanjutnya setelah serah terima pemakaian Barang inventaris ini, PIHAK KEDUA dapat mempergunakan sesuai dengan SPT No. <?php echo $data[0]->no_spt ?>, PIHAK KEDUA bertanggung jawab untuk memelihara Barang Inventaris tersebut serta sanggup untuk mengembalikan kepada dinas dalam keadaan baik dan tanpa syarat apapun juga.
			<br>
			Apabila terjadi kehilangan atau kerusakan barang milik negara tersebut, sehingga menimbulkan kerugian negara, PIHAK KEDUA bertanggung jawab mutlak, dan tunduk pada peraturan yang berlaku.
		</p>
		<table style="width: 100%">
			<tr>
