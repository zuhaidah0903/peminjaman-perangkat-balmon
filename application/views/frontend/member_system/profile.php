<div class="row">
		<div class="col-lg-12">
				<h1 class="page-header">Anda Login Sebagai Peminjam</h1>
		</div>
		<!-- /.col-lg-12 -->
</div>
			...
			<div class="panel panel-default">
				...
				<div class="form-group">
					<label class="col-md-1 col-xs-12 control-label">NIP</label>
					<div class="col-md-3 col-xs-12">
						<input type="text" name="" class="form-control" value="<?php echo $data->nip; ?>" disabled>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-1 col-xs-12 control-label">Bidang</label>
					<div class="col-md-3 col-xs-12">
						<input type="text" name="" class="form-control" value="<?php echo $data->bidang; ?>" disabled>
					</div>
				</div>
