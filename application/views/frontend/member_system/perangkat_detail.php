<div class="row">
    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal" method="POST" id="perangkat_detail" action="<?php echo base_url('member_system/perangkat_detail'); ?>">
...
<!--             <form method="post" action="<?= base_url('admin_system/perangkat_detail')?>" class="form-horizontal">  -->
              ...
              <div class="box-footer">
                <a href="<?= base_url('member_system/perangkat')?>" class="btn btn-warning">Close</a>
              </div>
            </form>
          </div>
        </div>